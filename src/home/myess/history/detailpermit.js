...
export default class DetailPermit extends Component {
    ...
    return (
      ...
      <Left><Icon style={{color:'white', width:50}} name="arrow-back" onPress={() => this.props.navigation.goBack()}/></Left>
        <Body style={{justifyContent: 'center', alignItems: 'center', flex:100,marginLeft: 50, marginRight: 50,width:'100%',}}>
          ...
          <Title style={{color: "white",fontWeight: "300" }}>Permit Details</Title>
      ...
      <View style={{width: '100%',backgroundColor:'#FFF', justifyContent: 'center'}}>
        <Icon style={{position: 'absolute',color:'grey',fontWeight:'bold',alignSelf:"flex-start", left:15}} name="list-box"/>

        <View style={{marginLeft: 50, marginRight:50, paddingTop:10, paddingBottom:10}}>
          <Text style={{fontWeight:'bold',color:'grey'}}>Izin {(parseInt(this.props.navigation.state.params.permit)+2).toString()} Hari</Text>
      ...
      <View style={{width: '100%',backgroundColor:'#FFF', padding:15}}>
        <Text style={{fontWeight:'bold',color:'grey',fontSize:14}}>Date Range</Text>
        <Text style={{color:'grey',fontSize:14}}>21 Agustus 2017 - 23 Agustus 2017</Text>
        <View style={{marginTop:10}}/>
