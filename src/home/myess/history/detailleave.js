...
export default class DetailLeave extends Component {
    ...
    return (
      ...
      <Left><Icon style={{color:'white', width:50}} name="arrow-back" onPress={() => this.props.navigation.goBack()}/></Left>
        <Body style={{justifyContent: 'center', alignItems: 'center', flex:100,marginLeft: 50, marginRight: 50,width:'100%',}}>
          ...
          <Title style={{color: "white",fontWeight: "300" }}>Leave Details</Title>
      ...
      <View style={{width: '100%',backgroundColor:'#FFF', justifyContent: 'center'}}>
        <Icon style={{position: 'absolute',color:'grey',fontWeight:'bold',alignSelf:"flex-start", left:15}} name="calendar"/>

        <View style={{marginLeft: 50, marginRight:50, paddingTop:10, paddingBottom:10}}>
          <Text style={{fontWeight:'bold',color:'grey'}}>Izin {(parseInt(this.props.navigation.state.params.leave)+2).toString()} Hari</Text>
