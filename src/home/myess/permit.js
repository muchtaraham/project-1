...
export default class Permit extends Component {
  ...
  render() {
    ...
    ShowPermitHideTextComponentView = (i) =>{
  	...
  	for(let i = 0; i < 2; i++){
        ...
        <Card  key={i} >
          <CardItem>
            <Body>
            <TouchableOpacity onPress={() => ShowPermitHideTextComponentView(i)} style={{width:'100%'}}>
            {this.state.status[i] ?
              <View style={styles.buttonRight}>
              <Icon onPress={() => ShowPermitHideTextComponentView(i)} style={{color:'grey'}} name="ios-arrow-down"/>
            </View>
            :
            <View style={styles.buttonRight}>
              <Icon onPress={() => ShowPermitHideTextComponentView(i)} style={{color:'grey'}} name="ios-more"/>
            </View>}
            <View>
      ...
      <Content style={{backgroundColor:'#f0eff5'}}>
        { permit }
          ...
          <Card>
            <CardItem>
            <Body>
            <TouchableOpacity onPress={() => this.props.navigation.navigate("HistoryPermit")} style={{width:'100%'}}>
            <View style={styles.buttonRight}>
